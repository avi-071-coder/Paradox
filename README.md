...
The engine goes a step further by generating highly specific, cinematic image prompts for each aspect of the simulation (cities, propaganda, documentary scenes) and renders them in real-time.
